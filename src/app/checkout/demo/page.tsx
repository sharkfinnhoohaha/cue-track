    ...
    <>
      ...
      <main className="mx-auto max-w-md px-4 sm:px-6 lg:px-8 pt-28 pb-20">
        <div className="rounded-2xl border border-black/[.08] bg-white p-8 text-center">
          ...
          <Link
            href={backHref}
            className="inline-flex items-center justify-center rounded-full bg-[#1d1d1f] px-6 py-3 text-[14px] font-semibold text-white hover:opacity-85 transition-opacity"
          >
            ← Go back
          </Link>
        </div>
