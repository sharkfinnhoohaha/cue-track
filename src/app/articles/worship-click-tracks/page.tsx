      ...
      <article className="pt-32 pb-20 px-6">
        <div className="max-w-3xl mx-auto">
          <header className="mb-12">
            ...
            <p className="font-body text-lg text-[#6e6e73] leading-relaxed">
          ...
          <div className="prose-dark space-y-12">
            ...
            <section>
              ...
              <p className="font-body text-[#3a3a3c] leading-relaxed mb-4">
              ...
              <p className="font-body text-[#3a3a3c] leading-relaxed">
            ...
            <section>
              ...
              <h3 className="font-display text-xl mb-3 text-[#1d1d1f]">Option 1: DAW-based (Ableton, Logic, MainStage)</h3>
              <p className="font-body text-[#3a3a3c] leading-relaxed mb-4">
              ...
              <h3 className="font-display text-xl mb-3 text-[#1d1d1f]">Option 2: Catalog-based apps (MultiTracks Playback, Loop Community Prime)</h3>
              <p className="font-body text-[#3a3a3c] leading-relaxed mb-4">
              ...
              <h3 className="font-display text-xl mb-3 text-[#1d1d1f]">Option 3: Web-based generation (the emerging path)</h3>
              <p className="font-body text-[#3a3a3c] leading-relaxed">
            ...
            <section>
              ...
              <div className="space-y-8">
                <div>
                  <h3 className="font-mono text-sm text-accent-500 uppercase tracking-wider mb-3">Step 1 — Determine the BPM</h3>
                  <p className="font-body text-[#3a3a3c] leading-relaxed mb-4">
                  ...
                  <div className="bg-surface-raised border border-surface-border rounded-lg p-6">
                    ...
                    <div className="space-y-2 font-body text-sm text-[#3a3a3c]">
                      <div><span className="font-mono text-[#1d1d1f]">60–75</span> — Slow ballads, reflective songs, prayers</div>
                      <div><span className="font-mono text-[#1d1d1f]">76–92</span> — Mid-tempo worship, groove-based songs</div>
                      <div><span className="font-mono text-[#1d1d1f]">93–110</span> — Contemporary pop worship (most Elevation, Hillsong UNITED)</div>
                      <div><span className="font-mono text-[#1d1d1f]">111–130</span> — Upbeat, high-energy anthems</div>
                      <div><span className="font-mono text-[#1d1d1f]">130+</span> — Fast praise, double-time feel songs</div>
                    </div>
                  </div>
                </div>

                <div>
                  <h3 className="font-mono text-sm text-accent-500 uppercase tracking-wider mb-3">Step 2 — Determine the time signature</h3>
                  <p className="font-body text-[#3a3a3c] leading-relaxed mb-4">
                ...
                <div>
                  <h3 className="font-mono text-sm text-accent-500 uppercase tracking-wider mb-3">Step 3 — Map the section structure in bars</h3>
                  <p className="font-body text-[#3a3a3c] leading-relaxed mb-4">
                  ...
                  <div className="bg-surface-raised border border-surface-border rounded-lg p-6 mb-4">
                    ...
                    <div className="space-y-1 font-mono text-sm text-[#3a3a3c]">
                      <div>Intro ................. <span className="text-[#1d1d1f]">4 bars</span></div>
                      <div>Verse 1 .............. <span className="text-[#1d1d1f]">8 bars</span></div>
                      <div>Pre-chorus ........... <span className="text-[#1d1d1f]">4 bars</span></div>
                      <div>Chorus ............... <span className="text-[#1d1d1f]">8 bars</span></div>
                      <div>Verse 2 .............. <span className="text-[#1d1d1f]">8 bars</span></div>
                      <div>Pre-chorus ........... <span className="text-[#1d1d1f]">4 bars</span></div>
                      <div>Chorus ............... <span className="text-[#1d1d1f]">8 bars</span></div>
                      <div>Bridge ............... <span className="text-[#1d1d1f]">8 bars</span></div>
                      <div>Chorus (final) ....... <span className="text-[#1d1d1f]">8 bars</span></div>
                      <div>Outro ................ <span className="text-[#1d1d1f]">4 bars</span></div>
                    </div>
                    <p className="font-mono text-xs text-[#86868b] mt-3">
                ...
                <div>
                  <h3 className="font-mono text-sm text-accent-500 uppercase tracking-wider mb-3">Step 4 — Choose your cue voice and style</h3>
                  <p className="font-body text-[#3a3a3c] leading-relaxed mb-4">
                    Voice cues should be clear, calm, and positioned in the mix so they cut
                    through without startling. Common approaches:
                  </p>
                  <ul className="font-body text-[#3a3a3c] leading-relaxed space-y-3 list-disc list-outside ml-6">
                    <li>
                      <strong className="text-[#1d1d1f]">Section name only:</strong> &quot;Verse,&quot;
                      &quot;Chorus,&quot; &quot;Bridge,&quot; &quot;Outro.&quot; Simple and direct.
                      Works for a band that runs the same arrangement every week and has the
                      structure memorized.
                    </li>
                    <li>
                      <strong className="text-[#1d1d1f]">Section with bar countdown:</strong>
                    ...
                    <li>
                      <strong className="text-[#1d1d1f]">Beat count-ins:</strong>
                ...
                <div>
                  <h3 className="font-mono text-sm text-accent-500 uppercase tracking-wider mb-3">Step 5 — Generate, listen, and test</h3>
                  <p className="font-body text-[#3a3a3c] leading-relaxed mb-4">
                    Once the track is generated, listen to the full file before using it at
                    rehearsal. Verify:
                  </p>
                  <ul className="font-body text-[#3a3a3c] leading-relaxed space-y-2 list-disc list-outside ml-6">
            ...
            <section>
              ...
              <h3 className="font-display text-xl mb-3 text-[#1d1d1f]">Basic hardware requirements</h3>
              <ol className="font-body text-[#3a3a3c] leading-relaxed mb-6 space-y-3 list-decimal list-outside ml-6">
                <li>
              ...
              <h3 className="font-display text-xl mb-3 text-[#1d1d1f]">Routing the click on a digital console</h3>
              <p className="font-body text-[#3a3a3c] leading-relaxed mb-4">
              ...
              <h3 className="font-display text-xl mb-3 text-[#1d1d1f]">Who gets the click in their mix</h3>
              <p className="font-body text-[#3a3a3c] leading-relaxed">
            ...
            <section>
              ...
              <div className="space-y-4">
                <div className="bg-surface-raised border border-surface-border rounded-lg p-6">
                  <h3 className="font-display text-lg mb-2 text-[#1d1d1f]">
            ...
            <div className="border-t border-surface-border pt-8 mt-12">
              <div className="bg-surface-raised border border-surface-border rounded-lg p-8 text-center">
                ...
                <p className="font-body text-[#6e6e73] mb-6">
