        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="prose-dark space-y-12">
            ...
            <section>
              ...
              <h3 className="font-display text-xl mb-3 text-neutral-200">Option 1: DAW-based (Ableton, Logic, MainStage)</h3>
              <p className="font-body text-neutral-300 leading-relaxed mb-4">
              ...
              <h3 className="font-display text-xl mb-3 text-neutral-200">Option 2: Catalog-based apps (MultiTracks Playback, Loop Community Prime)</h3>
              <p className="font-body text-neutral-300 leading-relaxed mb-4">
              ...
              <h3 className="font-display text-xl mb-3 text-neutral-200">Option 3: Web-based generation (the emerging path)</h3>
              <p className="font-body text-neutral-300 leading-relaxed">
              ...
              <div className="space-y-8">
                <div>
                  ...
                  <div className="bg-surface-raised border border-surface-border rounded-lg p-6">
                    ...
                    <div className="space-y-2 font-body text-sm text-neutral-300">
                      <div><span className="font-mono text-white">60–75</span> — Slow ballads, reflective songs, prayers</div>
                      <div><span className="font-mono text-white">76–92</span> — Mid-tempo worship, groove-based songs</div>
                      <div><span className="font-mono text-white">93–110</span> — Contemporary pop worship (most Elevation, Hillsong UNITED)</div>
                      <div><span className="font-mono text-white">111–130</span> — Upbeat, high-energy anthems</div>
                      <div><span className="font-mono text-white">130+</span> — Fast praise, double-time feel songs</div>
                    </div>
                  </div>
                </div>
                ...
                <div>
                  ...
                  <ul className="font-body text-neutral-300 leading-relaxed space-y-3 list-disc list-outside ml-6">
                    <li>
                      <strong className="text-white">Section name only:</strong> &quot;Verse,&quot;
                      &quot;Chorus,&quot; &quot;Bridge,&quot; &quot;Outro.&quot; Simple and direct.
                      Works for a band that runs the same arrangement every week and has the
                      structure memorized.
                    </li>
                    <li>
                      <strong className="text-white">Section with bar countdown:</strong>
                    ...
                    <li>
                      <strong className="text-white">Beat count-ins:</strong>
                ...
                <div>
                  ...
                  <ul className="font-body text-neutral-300 leading-relaxed space-y-2 list-disc list-outside ml-6">
            ...
            <section>
              ...
              <h3 className="font-display text-xl mb-3 text-neutral-200">Basic hardware requirements</h3>
              <ol className="font-body text-neutral-300 leading-relaxed mb-6 space-y-3 list-decimal list-outside ml-6">
                <li>
              ...
              <h3 className="font-display text-xl mb-3 text-neutral-200">Routing the click on a digital console</h3>
              <p className="font-body text-neutral-300 leading-relaxed mb-4">
              ...
              <h3 className="font-display text-xl mb-3 text-neutral-200">Who gets the click in their mix</h3>
              <p className="font-body text-neutral-300 leading-relaxed">
