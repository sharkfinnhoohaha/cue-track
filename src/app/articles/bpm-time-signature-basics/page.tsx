          ...
          <div className="prose-dark space-y-8">
            <section>
              ...
              <div className="bg-zinc-950-raised border border-surface-border rounded-lg p-6 my-6">
                ...
                <div className="grid grid-cols-2 gap-3 font-body text-sm text-zinc-300">
                  <div><span className="font-mono text-zinc-100">60–80</span> — Ballads, slow worship</div>
                  <div><span className="font-mono text-zinc-100">80–100</span> — Moderate groove</div>
                  <div><span className="font-mono text-zinc-100">100–120</span> — Pop, modern worship</div>
                  <div><span className="font-mono text-zinc-100">120–140</span> — Upbeat rock, dance</div>
                  <div><span className="font-mono text-zinc-100">140–170</span> — Fast rock, punk</div>
                  <div><span className="font-mono text-zinc-100">170–200+</span> — Double-time, metal</div>
                </div>
              </div>
            </section>
            ...
            <section>
              ...
              <div className="bg-zinc-950-raised border border-surface-border rounded-lg p-6 my-6">
                ...
                <div className="space-y-3 font-body text-sm text-zinc-300">
                  <div>
                    <span className="font-mono text-zinc-100">4/4</span> —
                    Most pop, rock, worship, and country. Four beats per bar.
                    The default if you&apos;re not sure.
                  </div>
                  <div>
                    <span className="font-mono text-zinc-100">3/4</span> —
                    Waltz time. Three beats per bar. Used in ballads and some hymns.
                  </div>
                  <div>
                    <span className="font-mono text-zinc-100">6/8</span> —
            ...
            <section>
              ...
              <div className="bg-zinc-950-raised border border-surface-border rounded-lg p-6 my-6">
                ...
                <div className="space-y-1 font-mono text-sm text-zinc-300">
                  ...
                  <div>Chorus ............. <span className="text-zinc-100">8 bars</span></div>
                  <div>Bridge ............. <span className="text-zinc-100">4 bars</span></div>
                  <div>Bridge (repeat) .... <span className="text-zinc-100">4 bars</span></div>
                  <div>Chorus (final) ..... <span className="text-zinc-100">8 bars</span></div>
                  <div>Outro/Tag .......... <span className="text-zinc-100">4 bars</span></div>
                </div>
