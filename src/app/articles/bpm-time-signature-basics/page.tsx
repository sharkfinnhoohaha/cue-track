          ...
          <div className="prose-dark space-y-8">
            <section>
              ...
              <div className="bg-surface-raised border border-surface-border rounded-lg p-6 my-6">
                ...
                <div className="grid grid-cols-2 gap-3 font-body text-sm text-[#3a3a3c]">
                  <div><span className="font-mono text-[#1d1d1f]">60–80</span> — Ballads, slow worship</div>
                  <div><span className="font-mono text-[#1d1d1f]">80–100</span> — Moderate groove</div>
                  <div><span className="font-mono text-[#1d1d1f]">100–120</span> — Pop, modern worship</div>
                  <div><span className="font-mono text-[#1d1d1f]">120–140</span> — Upbeat rock, dance</div>
                  <div><span className="font-mono text-[#1d1d1f]">140–170</span> — Fast rock, punk</div>
                  <div><span className="font-mono text-[#1d1d1f]">170–200+</span> — Double-time, metal</div>
                </div>
              </div>
            </section>
            ...
            <section>
              ...
              <div className="bg-surface-raised border border-surface-border rounded-lg p-6 my-6">
                ...
                <div className="space-y-3 font-body text-sm text-[#3a3a3c]">
                  <div>
                    <span className="font-mono text-[#1d1d1f]">4/4</span> —
                    Most pop, rock, worship, and country. Four beats per bar.
                    The default if you&apos;re not sure.
                  </div>
                  <div>
                    <span className="font-mono text-[#1d1d1f]">3/4</span> —
                    Waltz time. Three beats per bar. Used in ballads and some hymns.
                  </div>
                  <div>
                    <span className="font-mono text-[#1d1d1f]">6/8</span> —
            ...
            <section>
              ...
              <div className="bg-surface-raised border border-surface-border rounded-lg p-6 my-6">
                ...
                <div className="space-y-1 font-mono text-sm text-[#3a3a3c]">
                  ...
                  <div>Chorus ............. <span className="text-[#1d1d1f]">8 bars</span></div>
                  <div>Bridge ............. <span className="text-[#1d1d1f]">4 bars</span></div>
                  <div>Bridge (repeat) .... <span className="text-[#1d1d1f]">4 bars</span></div>
                  <div>Chorus (final) ..... <span className="text-[#1d1d1f]">8 bars</span></div>
                  <div>Outro/Tag .......... <span className="text-[#1d1d1f]">4 bars</span></div>
                </div>
