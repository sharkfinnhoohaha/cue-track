          ...
          <div className="prose-dark space-y-12">
            ...
            <section>
              ...
              <p className="font-body text-zinc-300 leading-relaxed mb-4">
                A <strong className="text-zinc-100">click track</strong> is a metronome: a steady
              ...
              <p className="font-body text-zinc-300 leading-relaxed mb-4">
                A <strong className="text-zinc-100">cue track</strong> is a click track with spoken
              ...
              <div className="bg-zinc-950-raised border border-surface-border rounded-lg p-6 my-6">
                ...
                <div className="space-y-4 font-mono text-sm text-zinc-300">
                  <div>
                    <div className="text-zinc-500 mb-1">Click only — tempo without context:</div>
                    <div>tick tick tick tick | tick tick tick tick | tick tick tick tick...</div>
                  </div>
                  <div>
                    <div className="text-zinc-500 mb-1">Click + cues — tempo with direction:</div>
                    <div>tick tick tick tick | tick tick <span className="text-accent">&quot;Verse&quot;</span> tick | <span className="text-accent">&quot;1, 2, 3, 4&quot;</span> | TICK tick tick tick...</div>
                  </div>
                </div>
              </div>
              <p className="font-body text-zinc-300 leading-relaxed mb-4">
            ...
            <section>
              ...
              <div className="space-y-4 mb-6">
                <div className="flex gap-4">
                  <div className="text-accent font-mono text-sm mt-1 shrink-0">01</div>
                  <div>
                    <h3 className="font-display text-lg mb-1 text-zinc-100">You cannot hear the drummer count off</h3>
                ...
                <div className="flex gap-4">
                  <div className="text-accent font-mono text-sm mt-1 shrink-0">02</div>
                  <div>
                    <h3 className="font-display text-lg mb-1 text-zinc-100">Visual signals are unreliable</h3>
                    <p className="font-body text-sm text-zinc-300 leading-relaxed">
                ...
                <div className="flex gap-4">
                  <div className="text-accent font-mono text-sm mt-1 shrink-0">03</div>
                  <div>
                    <h3 className="font-display text-lg mb-1 text-zinc-100">Counting bars silently is high cognitive load</h3>
                    <p className="font-body text-sm text-zinc-300 leading-relaxed">
                ...
                <div className="flex gap-4">
                  <div className="text-accent font-mono text-sm mt-1 shrink-0">04</div>
                  <div>
                    <h3 className="font-display text-lg mb-1 text-zinc-100">Substitutes and first-timers need audio navigation</h3>
                    <p className="font-body text-sm text-zinc-300 leading-relaxed">
              ...
              <div className="space-y-6">
                <div>
                  <div className="border-l-2 border-accent-500 pl-6 mb-4">
                    <h3 className="font-display text-xl mb-2 text-zinc-100">Section announcements</h3>
                    <p className="font-body text-sm text-zinc-500 font-mono">
                ...
                <div>
                  <div className="border-l-2 border-accent-500/60 pl-6 mb-4">
                    <h3 className="font-display text-xl mb-2 text-zinc-100">Count-ins</h3>
                    <p className="font-body text-sm text-zinc-500 font-mono">
                  ...
                  <ul className="font-body text-zinc-300 leading-relaxed space-y-2 list-disc list-outside ml-6 mb-4">
                ...
                <div>
                  <div className="border-l-2 border-accent-500/40 pl-6 mb-4">
                    <h3 className="font-display text-xl mb-2 text-zinc-100">Bar countdowns</h3>
                    <p className="font-body text-sm text-zinc-500 font-mono">
            ...
            <section>
              ...
              <h3 className="font-display text-xl mb-3 text-zinc-100">Principle 1: Start with less than you think you need</h3>
              <p className="font-body text-zinc-300 leading-relaxed mb-4">
              ...
              <p className="font-body text-zinc-300 leading-relaxed mb-6">
              ...
              <h3 className="font-display text-xl mb-3 text-zinc-100">Principle 2: Use the same terminology the band uses</h3>
              <p className="font-body text-zinc-300 leading-relaxed mb-4">
              ...
              <h3 className="font-display text-xl mb-3 text-zinc-100">Principle 3: One bar of warning is usually right</h3>
              <p className="font-body text-zinc-300 leading-relaxed mb-4">
              ...
              <h3 className="font-display text-xl mb-3 text-zinc-100">Principle 4: Mix the cue voice to sit under the click, not over it</h3>
              <p className="font-body text-zinc-300 leading-relaxed mb-4">
            ...
            <section>
              ...
              <div className="bg-zinc-950-raised border border-surface-border rounded-lg p-6">
                ...
                <div className="space-y-1 font-mono text-sm text-zinc-300">
                  <div className="text-zinc-500 mb-2">— Bar — Section — Cue fires</div>
                  <div>Bar 1–4 ....... Intro .......... <span className="text-accent">&quot;1, 2, 3, 4&quot; on bar 1</span></div>
                  <div>Bar 4 beat 4 .. ............... <span className="text-accent">&quot;Verse&quot; on bar 4 beat 4</span></div>
                  <div>Bar 5–12 ...... Verse 1 .......</div>
                  <div>Bar 12 beat 4 . ............... <span className="text-accent">&quot;Chorus&quot; on bar 12 beat 4</span></div>
                  <div>Bar 13–20 ..... Chorus ........</div>
                  <div>Bar 20 beat 4 . ............... <span className="text-accent">&quot;Verse&quot; on bar 20 beat 4</span></div>
                  <div>Bar 21–28 ..... Verse 2 .......</div>
                  <div>Bar 28 beat 4 . ............... <span className="text-accent">&quot;Chorus&quot; on bar 28 beat 4</span></div>
                  <div>Bar 29–36 ..... Chorus ........</div>
                  <div>Bar 35 beat 1 . ............... <span className="text-accent">&quot;4 bars&quot; (bridge countdown)</span></div>
                  <div>Bar 36 beat 1 . ............... <span className="text-accent">&quot;3 bars&quot;</span></div>
                  <div>Bar 36 beat 3 . ............... <span className="text-accent">&quot;Bridge&quot;</span></div>
                  <div>Bar 37–44 ..... Bridge ........</div>
                  <div>Bar 44 beat 4 . ............... <span className="text-accent">&quot;Chorus&quot; on bar 44 beat 4</span></div>
                  <div>Bar 45–52 ..... Final Chorus ..</div>
                  <div>Bar 52 beat 4 . ............... <span className="text-accent">&quot;Outro&quot; on bar 52 beat 4</span></div>
                  <div>Bar 53–56 ..... Outro .........</div>
                </div>
              </div>
              <p className="font-body text-zinc-300 leading-relaxed mt-4">
            ...
            <section>
              ...
              <h3 className="font-display text-xl mb-3 text-zinc-100">Entry-level setup (single shared level)</h3>
              <p className="font-body text-zinc-300 leading-relaxed mb-4">
              ...
              <h3 className="font-display text-xl mb-3 text-zinc-100">Personal mix setup (individual control)</h3>
              <p className="font-body text-zinc-300 leading-relaxed mb-4">
              ...
              <h3 className="font-display text-xl mb-3 text-zinc-100">Multitrack setup (click embedded in a full stem session)</h3>
              <p className="font-body text-zinc-300 leading-relaxed mb-4">
              ...
              <h3 className="font-display text-xl mb-3 text-zinc-100">IEM hardware options at different price points</h3>
              <div className="space-y-3 mt-4">
                <div className="bg-zinc-950-raised border border-surface-border rounded-lg p-5">
                  <div className="flex items-baseline gap-3 mb-2">
                    <span className="font-mono text-xs text-accent uppercase tracking-wider">Budget</span>
                    <span className="font-display text-sm text-zinc-100">Under $200 total</span>
                  </div>
                  <p className="font-body text-sm text-zinc-300 leading-relaxed">
                ...
                <div className="bg-zinc-950-raised border border-surface-border rounded-lg p-5">
                  <div className="flex items-baseline gap-3 mb-2">
                    <span className="font-mono text-xs text-accent uppercase tracking-wider">Mid-range</span>
                    <span className="font-display text-sm text-zinc-100">$400–$800 per user</span>
                  </div>
                  <p className="font-body text-sm text-zinc-300 leading-relaxed">
                ...
                <div className="bg-zinc-950-raised border border-surface-border rounded-lg p-5">
                  <div className="flex items-baseline gap-3 mb-2">
                    <span className="font-mono text-xs text-accent uppercase tracking-wider">Professional</span>
                    <span className="font-display text-sm text-zinc-100">$1,000+ per user</span>
                  </div>
                  <p className="font-body text-sm text-zinc-300 leading-relaxed">
