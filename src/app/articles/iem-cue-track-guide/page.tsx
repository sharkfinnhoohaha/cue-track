          ...
          <div className="prose-dark space-y-12">
            ...
            <section>
              ...
              <p className="font-body text-[#3a3a3c] leading-relaxed mb-4">
                A <strong className="text-[#1d1d1f]">click track</strong> is a metronome: a steady
              ...
              <p className="font-body text-[#3a3a3c] leading-relaxed mb-4">
                A <strong className="text-[#1d1d1f]">cue track</strong> is a click track with spoken
              ...
              <div className="bg-surface-raised border border-surface-border rounded-lg p-6 my-6">
                ...
                <div className="space-y-4 font-mono text-sm text-[#3a3a3c]">
                  <div>
                    <div className="text-[#86868b] mb-1">Click only — tempo without context:</div>
                    <div>tick tick tick tick | tick tick tick tick | tick tick tick tick...</div>
                  </div>
                  <div>
                    <div className="text-[#86868b] mb-1">Click + cues — tempo with direction:</div>
            ...
            <section>
              ...
              <div className="space-y-4 mb-6">
                <div className="flex gap-4">
                  ...
                  <div>
                    <h3 className="font-display text-lg mb-1 text-[#1d1d1f]">You cannot hear the drummer count off</h3>
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    <h3 className="font-display text-lg mb-1 text-[#1d1d1f]">Visual signals are unreliable</h3>
                    <p className="font-body text-sm text-[#3a3a3c] leading-relaxed">
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    <h3 className="font-display text-lg mb-1 text-[#1d1d1f]">Counting bars silently is high cognitive load</h3>
                    <p className="font-body text-sm text-[#3a3a3c] leading-relaxed">
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    <h3 className="font-display text-lg mb-1 text-[#1d1d1f]">Substitutes and first-timers need audio navigation</h3>
                    <p className="font-body text-sm text-[#3a3a3c] leading-relaxed">
              ...
              <div className="space-y-6">
                <div>
                  <div className="border-l-2 border-accent-500 pl-6 mb-4">
                    <h3 className="font-display text-xl mb-2 text-[#1d1d1f]">Section announcements</h3>
                    <p className="font-body text-sm text-[#86868b] font-mono">
                ...
                <div>
                  <div className="border-l-2 border-accent-500/60 pl-6 mb-4">
                    <h3 className="font-display text-xl mb-2 text-[#1d1d1f]">Count-ins</h3>
                    <p className="font-body text-sm text-[#86868b] font-mono">
                  ...
                  <ul className="font-body text-[#3a3a3c] leading-relaxed space-y-2 list-disc list-outside ml-6 mb-4">
                ...
                <div>
                  <div className="border-l-2 border-accent-500/40 pl-6 mb-4">
                    <h3 className="font-display text-xl mb-2 text-[#1d1d1f]">Bar countdowns</h3>
                    <p className="font-body text-sm text-[#86868b] font-mono">
            ...
            <section>
              ...
              <h3 className="font-display text-xl mb-3 text-[#1d1d1f]">Principle 1: Start with less than you think you need</h3>
              <p className="font-body text-[#3a3a3c] leading-relaxed mb-4">
              ...
              <p className="font-body text-[#3a3a3c] leading-relaxed mb-6">
              ...
              <h3 className="font-display text-xl mb-3 text-[#1d1d1f]">Principle 2: Use the same terminology the band uses</h3>
              <p className="font-body text-[#3a3a3c] leading-relaxed mb-4">
              ...
              <h3 className="font-display text-xl mb-3 text-[#1d1d1f]">Principle 3: One bar of warning is usually right</h3>
              <p className="font-body text-[#3a3a3c] leading-relaxed mb-4">
              ...
              <h3 className="font-display text-xl mb-3 text-[#1d1d1f]">Principle 4: Mix the cue voice to sit under the click, not over it</h3>
              <p className="font-body text-[#3a3a3c] leading-relaxed mb-4">
            ...
            <section>
              ...
              <div className="bg-surface-raised border border-surface-border rounded-lg p-6">
                ...
                <div className="space-y-1 font-mono text-sm text-[#3a3a3c]">
                  <div className="text-[#86868b] mb-2">— Bar — Section — Cue fires</div>
              ...
              <p className="font-body text-[#3a3a3c] leading-relaxed mt-4">
            ...
            <section>
              ...
              <h3 className="font-display text-xl mb-3 text-[#1d1d1f]">Entry-level setup (single shared level)</h3>
              <p className="font-body text-[#3a3a3c] leading-relaxed mb-4">
              ...
              <h3 className="font-display text-xl mb-3 text-[#1d1d1f]">Personal mix setup (individual control)</h3>
              <p className="font-body text-[#3a3a3c] leading-relaxed mb-4">
              ...
              <h3 className="font-display text-xl mb-3 text-[#1d1d1f]">Multitrack setup (click embedded in a full stem session)</h3>
              <p className="font-body text-[#3a3a3c] leading-relaxed mb-4">
              ...
              <h3 className="font-display text-xl mb-3 text-[#1d1d1f]">IEM hardware options at different price points</h3>
              <div className="space-y-3 mt-4">
                <div className="bg-surface-raised border border-surface-border rounded-lg p-5">
                  <div className="flex items-baseline gap-3 mb-2">
                    ...
                    <span className="font-display text-sm text-[#1d1d1f]">Under $200 total</span>
                  </div>
                  <p className="font-body text-sm text-[#3a3a3c] leading-relaxed">
                ...
                <div className="bg-surface-raised border border-surface-border rounded-lg p-5">
                  <div className="flex items-baseline gap-3 mb-2">
                    ...
                    <span className="font-display text-sm text-[#1d1d1f]">$400–$800 per user</span>
                  </div>
                  <p className="font-body text-sm text-[#3a3a3c] leading-relaxed">
                ...
                <div className="bg-surface-raised border border-surface-border rounded-lg p-5">
                  <div className="flex items-baseline gap-3 mb-2">
                    ...
                    <span className="font-display text-sm text-[#1d1d1f]">$1,000+ per user</span>
                  </div>
                  <p className="font-body text-sm text-[#3a3a3c] leading-relaxed">
